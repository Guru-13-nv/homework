...
def send_email(message, recipient, *, sender='university.help@gmail.com'):
    err_list = ['@', '.com', '.ru', '.net']
    bool_err = 0
    for meaning_1 in err_list:
        bool_err = bool_err + int(meaning_1 in recipient) + int(meaning_1 in sender)
    if bool_err < 4:
...
'''Тестирование работы разных выборок'''
# a='urban.fan@mail.ru'
# b=['@', '.com', '.ru', '.net']
# for c in b:#Цикл с использованием метода сравнения строк
#     d=a.find(c)
#     print(d)
# for c in b:#Цикл с использованием метода вхождения
#     d=c in a
#     print(d)
# #print(f'{a}, {b}, {a.find(b)}')
